        ...
        <div className="main">
          ...
          <main className="content">
            ...
            <div className="kpi-grid">
              <div className="kpi-card"><div className="kpi-top"><div className="kpi-icon"><Icon name="file" /></div></div><div className="kpi-value tabular" style={{ color: 'var(--accent)' }}>{loading ? '—' : kpis.total}</div><div className="kpi-label">Total Assets</div><div className="kpi-deco"><Icon name="file" size={56} /></div></div>
              <div className="kpi-card"><div className="kpi-top"><div className="kpi-icon"><Icon name="clock" /></div></div><div className="kpi-value tabular" style={{ color: 'var(--accent)' }}>{loading ? '—' : kpis.recentlyUpdated}</div><div className="kpi-label">গত ৭ দিনে যোগ হয়েছে</div><div className="kpi-deco"><Icon name="clock" size={56} /></div></div>
              <div className="kpi-card"><div className="kpi-top"><div className="kpi-icon" style={{ background: 'var(--warning-soft)', color: 'var(--warning)' }}><Icon name="building" /></div></div><div className="kpi-value tabular" style={{ color: 'var(--warning)' }}>{loading ? '—' : kpis.clientFiles}</div><div className="kpi-label">Client Files</div><div className="kpi-deco" style={{ color: 'var(--warning)' }}><Icon name="building" size={56} /></div></div>
              <div className="kpi-card"><div className="kpi-top"><div className="kpi-icon" style={{ background: 'var(--positive-soft)', color: 'var(--positive)' }}><Icon name="check-circle" /></div></div><div className="kpi-value tabular" style={{ color: 'var(--positive)' }}>{loading ? '—' : kpis.readyForHandoff}</div><div className="kpi-label">Ready for Handoff</div><div className="kpi-deco" style={{ color: 'var(--positive)' }}><Icon name="check-circle" size={56} /></div></div>
              <div className="kpi-card"><div className="kpi-top"><div className="kpi-icon" style={{ background: 'var(--warning-soft)', color: 'var(--warning)' }}><Icon name="eye" /></div></div><div className="kpi-value tabular" style={{ color: 'var(--warning)' }}>{loading ? '—' : kpis.pendingReview}</div><div className="kpi-label">Pending Review</div><div className="kpi-deco" style={{ color: 'var(--warning)' }}><Icon name="eye" size={56} /></div></div>
            </div>
